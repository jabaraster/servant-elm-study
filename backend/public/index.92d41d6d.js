...
})({"1snBF":[function(require,module,exports,__globalThis) {
...
module.bundle.HMR_BUNDLE_ID = "5e9521eb92d41d6d";
"use strict";
...
console.log("Elm: ", (0, _mainElm.Elm));
function tag(id) {
...
document.addEventListener("DOMContentLoaded", async ()=>{
    ...
    tag("console").innerText = JSON.stringify(users, null, 2);
});
...
*/ var _Scheduler_working = false;
    ...
    var $author$project$Main$update = F2(function(msg, model) {
        if (msg.$ === 'Increment') return model + 1;
        else return model - 1;
    });
...
},{}]},["1snBF","kuM8f"], "kuM8f", "parcelRequire94c2")

//# sourceMappingURL=index.92d41d6d.js.map
